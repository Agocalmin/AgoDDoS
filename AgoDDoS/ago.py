...
l7 = ["CFB", "BYPASS", "AGO", "POST", "OVH", "STRESS", "OSTRESS", "DYN", "SLOW", "HEAD", "HIT", "NULL", "COOKIE", "BRUST", "PPS", "EVEN", "GSB", "DGB", "AVB"]
...
def usge():
    usgeaseets()
    print('* Coded By Agocalmin For DDoS')
